        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                fontWeight: '600',
                backgroundColor: tipo === 'cliente' ? '#16a34a' : '#f3f4f6',
                color: tipo === 'cliente' ? 'white' : '#374151'
              }}
            >
              Aventureiro
            </button>
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                fontWeight: '600',
                backgroundColor: tipo === 'guia' ? '#16a34a' : '#f3f4f6',
                color: tipo === 'guia' ? 'white' : '#374151'
              }}
            >
              Guia
            </button>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <input
              ...
              style={{ width: '100%', padding: '12px 16px', border: '1px solid #e5e7eb', borderRadius: '12px', fontSize: '14px', outline: 'none' }}
          ...
          {erro && (
            <div style={{ backgroundColor: '#fee2e2', color: '#dc2626', padding: '12px', borderRadius: '12px', fontSize: '13px', textAlign: 'center', marginBottom: '16px' }}>
              {erro}
            </div>
          )}

          {sucesso && (
            <div style={{ backgroundColor: '#dcfce7', color: '#16a34a', padding: '12px', borderRadius: '12px', fontSize: '13px', textAlign: 'center', marginBottom: '16px' }}>
              {sucesso}
            </div>
          )}
