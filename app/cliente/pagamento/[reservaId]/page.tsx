  ...
  useEffect(() => {
    const carregarPagamento = async () => {
      ...
      const { data: reserva } = await supabase
        .from('reservas')
        .select('*, roteiro:roteiro_id(titulo, preco), pagamento_status, status')
        .eq('id', reservaId)
        .single()
      ...
      // Se já está paga ou confirmada, redireciona
      ...
      // Criar cobrança PIX na PagHiper
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        {mensagem && (
          <div style={{ 
            ...
            textAlign: 'center', 
            fontSize: '13px',
            backgroundColor: mensagem.includes('✅') ? '#dcfce7' : '#fef3c7',
            color: mensagem.includes('✅') ? '#16a34a' : '#d97706'
          }}>
            {mensagem}
          </div>
        )}
