...
export default function CriarRoteiroPage() {
  ...
  const iniciarPagina = async () => {
    try {
      ...
      console.error('Erro ao iniciar página de criar roteiro:', error)
  ...
  const criarRoteiro = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (resultado.colunasIgnoradas.length > 0) {
        ...
        setMensagem(
          `Roteiro criado com sucesso. Atenção: algumas colunas ainda não existem no banco e foram ignoradas: ${resultado.colunasIgnoradas.join(', ')}. Rode o SQL de atualização depois.`
        )
      } else {
      ...
      setMensagem(
        error?.message ||
        'Erro ao criar roteiro. Verifique as colunas da tabela roteiros no Supabase.'
      )
      ...
      <div className="container">
        <section className="intro">
          <div className="hero-card">
            ...
            <p className="hero-text">
              Preencha as informações principais do roteiro. Para o MVP,
              a data, o horário e o local de encontro ficam em campos simples
              de texto, facilitando o cadastro pelo guia sem travar o fluxo.
            </p>
          </div>
          ...
          <aside className="side-card">
            ...
            <div className="side-list">
              <div className="side-item">
                ...
                <span>Use data em texto: 15/07/2026 ou “a combinar”.</span>
              </div>

              <div className="side-item">
                <span className="side-dot" />
                <span>Use horário em texto: 07h30 ou “saída ao amanhecer”.</span>
              </div>

              <div className="side-item">
                <span className="side-dot" />
                <span>Local de encontro separado do local geral do roteiro.</span>
              </div>
            </div>
          </aside>
        </section>
        ...
        <form className="form-card" onSubmit={criarRoteiro}>
          ...
          <div className="form-grid">
            ...
            <div className="form-group full">
              <label>Imagem do roteiro</label>
              <input
                value={form.imagem_url}
                onChange={(event) =>
                  atualizarCampo('imagem_url', event.target.value)
                }
                placeholder="Cole aqui a URL da imagem, se tiver"
              />
              <span className="helper">
                Opcional. Depois podemos evoluir para upload direto de imagem.
              </span>
            </div>
          </div>
