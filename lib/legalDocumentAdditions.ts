...
1.1. Esta Política disciplina cancelamentos, desistências, remarcações, reembolsos, estornos, créditos internos, Saldo de Jornada e reflexos financeiros relacionados às reservas realizadas pela Plataforma PrussikTrails.

1.2. Esta Política complementa os Termos de Uso, o Termo de Ciência de Riscos, o Termo do Guia, a Política de Privacidade e, quando aplicável, o Termo do Programa de Afiliados.

1.3. Havendo condição específica claramente informada na página do roteiro antes da contratação, ela somente poderá complementar esta Política, preservar os direitos legais do consumidor e observar os princípios da informação, transparência, boa-fé, proporcionalidade e equilíbrio contratual.

2. DIREITO DE ARREPENDIMENTO NAS CONTRATAÇÕES ONLINE

2.1. Nas contratações realizadas pelo site, aplicativo, PWA ou outro ambiente digital da PrussikTrails, o Cliente poderá exercer o direito de arrependimento no prazo de 7 (sete) dias corridos, contado da data da contratação, desde que a atividade ainda não tenha sido realizada.

2.2. O exercício válido do direito de arrependimento assegurará o reembolso integral de todos os valores efetivamente pagos na contratação, inclusive eventuais taxas, sem aplicação de multa, retenção administrativa ou desconto de custo de transação.

2.3. O Cliente poderá exercer o direito de arrependimento pela mesma ferramenta utilizada para a contratação, quando tecnicamente disponível, ou por outro canal oficial de atendimento disponibilizado pela PrussikTrails.

2.4. A Plataforma encaminhará confirmação do recebimento do pedido de arrependimento e adotará as providências necessárias para o cancelamento e a devolução dos valores, observados os prazos operacionais do meio de pagamento.

2.5. Encerrado o prazo legal de arrependimento, eventual cancelamento voluntário solicitado pelo Cliente seguirá as regras do item 3, conforme a antecedência em relação à data e ao horário de início do roteiro.

3. CANCELAMENTO VOLUNTÁRIO APÓS O PRAZO DE ARREPENDIMENTO

3.1. Depois de encerrado o prazo legal de arrependimento, e sem prejuízo de outros direitos assegurados pela legislação, aplicam-se inicialmente as seguintes condições:

a) cancelamento com antecedência de 15 (quinze) dias ou mais em relação ao início do roteiro: reembolso financeiro de 90% (noventa por cento) do valor efetivamente pago ou concessão de 100% (cem por cento) em Saldo de Jornada, conforme escolha do Cliente;

b) cancelamento com antecedência inferior a 15 (quinze) dias e superior a 72 (setenta e duas) horas em relação ao início do roteiro: reembolso financeiro de 80% (oitenta por cento) do valor efetivamente pago ou concessão de 100% (cem por cento) em Saldo de Jornada, conforme escolha do Cliente;

c) cancelamento com antecedência igual ou inferior a 72 (setenta e duas) horas e igual ou superior a 24 (vinte e quatro) horas em relação ao início do roteiro: reembolso financeiro de 70% (setenta por cento) do valor efetivamente pago ou concessão de 85% (oitenta e cinco por cento) em Saldo de Jornada, conforme escolha do Cliente;

d) cancelamento com antecedência inferior a 24 (vinte e quatro) horas ou não comparecimento: não haverá reembolso automático, ressalvada análise excepcional em caso de doença comprovada, caso fortuito, força maior ou outra circunstância relevante.

3.2. Os percentuais retidos nas alíneas do item 3.1 já compreendem os custos administrativos, financeiros, tecnológicos e operacionais ordinariamente relacionados à reserva e ao cancelamento. Não será aplicada taxa adicional automática de transação, processamento ou administração sobre o valor do reembolso.

3.3. A retenção deverá ser aplicada de forma razoável e proporcional, considerando os custos efetivamente incorridos, a antecedência do cancelamento, a possibilidade de substituição do participante e as características do roteiro.

3.4. Se a vaga cancelada for posteriormente preenchida por outro participante, ou se os custos efetivamente mantidos forem inferiores ao percentual inicialmente retido, a PrussikTrails poderá rever a retenção e ampliar o valor do reembolso, de ofício ou mediante solicitação fundamentada do Cliente.

3.5. O Cliente poderá solicitar o detalhamento dos custos considerados na análise do cancelamento, que será disponibilizado preferencialmente em até 5 (cinco) dias úteis, conforme a complexidade e a disponibilidade das informações.

3.6. Despesas extraordinárias, específicas, efetivamente realizadas e comprovadamente irrecuperáveis somente poderão ser consideradas quando:

a) estiverem diretamente relacionadas à reserva cancelada;

b) não estiverem incluídas no percentual ordinariamente retido;

c) tiverem sido informadas de maneira clara antes da contratação;

d) puderem ser individualmente discriminadas e comprovadas;

e) respeitarem a razoabilidade, a proporcionalidade e a legislação aplicável.

3.7. O Saldo de Jornada será sempre uma alternativa voluntária. O Cliente não será obrigado a aceitar crédito interno em substituição ao reembolso financeiro quando possuir direito a este.

4. CANCELAMENTO PELO GUIA OU PELA PRUSSIKTRAILS

4.1. Em caso de cancelamento pelo Guia, impossibilidade operacional, indisponibilidade relevante, risco climático grave, força maior ou decisão administrativa da Plataforma, o Cliente poderá receber, conforme o caso e sem prejuízo de seus direitos legais:

a) reembolso integral;

b) remarcação;

c) Saldo de Jornada integral.

4.2. A escolha oferecida deverá considerar a segurança, a proximidade da atividade, a possibilidade de remarcação e a manifestação do Cliente.

4.3. A segurança dos participantes prevalecerá sobre a realização do roteiro quando houver risco relevante.

5. ALTERAÇÃO DE DATA, HORÁRIO, LOCAL OU CONDIÇÕES ESSENCIAIS

5.1. Alterações relevantes deverão ser comunicadas ao Cliente pelos canais disponíveis.

5.2. Quando a alteração modificar substancialmente a experiência contratada, o Cliente poderá solicitar cancelamento sem penalidade, remarcação ou crédito integral.

5.3. Pequenos ajustes operacionais que não alterem a essência, o nível de dificuldade ou a segurança poderão ser realizados pelo Guia, mediante comunicação adequada.

6. REEMBOLSO E PRAZO OPERACIONAL

6.1. Após a aprovação do reembolso e o fornecimento dos dados necessários, a PrussikTrails adotará as providências para devolução em até 7 (sete) dias úteis.

6.2. O prazo de crédito efetivo poderá variar conforme o banco, instituição de pagamento, PagHiper ou outro provedor utilizado.

6.3. Dados bancários incorretos, divergência de titularidade, bloqueios bancários, indisponibilidade de terceiros ou análise antifraude poderão ampliar o prazo.

6.4. Quando possível, o reembolso será realizado pelo mesmo meio de pagamento ou para conta ou chave PIX de titularidade do Cliente.

7. SALDO DE JORNADA

7.1. Saldo de Jornada é crédito interno destinado exclusivamente à aquisição de novas experiências na PrussikTrails.

7.2. O Saldo de Jornada:

a) não é conta bancária;

b) não rende juros;

c) não pode ser transferido livremente entre Usuários;

d) não pode ser sacado, salvo obrigação legal ou decisão administrativa excepcional;

e) será utilizado conforme os Termos de Uso.

7.3. A conversão voluntária de valor reembolsável em Saldo de Jornada deverá ser informada de forma clara.

8. PAGAMENTO COM MÚLTIPLAS ORIGENS

8.1. Quando a reserva for paga por PIX, Saldo de Jornada, Saldo de Comissões ou outro crédito autorizado, o sistema deverá registrar separadamente cada origem.

8.2. Em caso de cancelamento, a devolução respeitará, sempre que tecnicamente possível, a origem de cada parcela.

8.3. Não será permitido creditar duas vezes o mesmo valor por falha, duplicidade de webhook, cancelamento repetido ou estorno já executado.

9. REFLEXOS SOBRE COMISSÕES DE AFILIADOS

9.1. Reserva cancelada, integralmente reembolsada, objeto de chargeback, fraude ou duplicidade não gera comissão definitiva de Afiliado.

9.2. Se a comissão estiver pendente, será cancelada.

9.3. Se estiver disponível, poderá ser estornada no Saldo de Comissões.

9.4. Se já tiver sido utilizada ou sacada, a PrussikTrails poderá compensar o valor com comissões futuras, registrar saldo devedor ou solicitar restituição, mediante demonstração no extrato.

9.5. Em reembolso parcial, a comissão poderá ser recalculada proporcionalmente à base de cálculo efetivamente mantida.

10. CHARGEBACK E CONTESTAÇÃO

10.1. Contestação de pagamento deverá ser comunicada à Plataforma para análise dos registros da reserva.

10.2. Chargeback fraudulento ou de má-fé poderá gerar suspensão da conta, bloqueio de saldos, impedimento de novas reservas e adoção de medidas de cobrança.

10.3. Valores relacionados à transação contestada poderão permanecer bloqueados até a conclusão da análise.

11. NÃO COMPARECIMENTO E ATRASO

11.1. O não comparecimento do Cliente, sem comunicação tempestiva, não gera reembolso automático.

11.2. Atrasos deverão seguir a tolerância informada pelo Guia na página do roteiro.

11.3. Quando o atraso inviabilizar a segurança, a logística ou a saída do grupo, o Guia poderá impedir a participação, registrando o ocorrido.

12. CONDIÇÕES DE SAÚDE, CASO FORTUITO E FORÇA MAIOR

12.1. Situações excepcionais poderão ser analisadas mediante documentação compatível, sem garantia automática de reembolso integral.

12.2. A análise considerará a antecedência, os custos já incorridos, a possibilidade de substituição da vaga e os elementos apresentados pelo Cliente.

13. SOLICITAÇÃO E DOCUMENTOS

13.1. A solicitação deverá conter:
...
e) comprovante de pagamento, quando necessário;

f) documentos que sustentem situação excepcional.

13.2. A PrussikTrails poderá solicitar informação complementar estritamente necessária à análise.

14. AUDITORIA E PROVAS DIGITAIS

14.1. Poderão ser utilizados registros de pagamento, webhooks, logs, mensagens, status da reserva, histórico do roteiro, aceite dos termos e comunicações oficiais.

14.2. Ajustes administrativos deverão registrar motivo, responsável, data, valor anterior e valor novo.

15. ATUALIZAÇÕES

15.1. Esta Política poderá ser atualizada por razões legais, técnicas, operacionais ou comerciais.

15.2. Alterações materiais serão comunicadas por meio adequado e não prejudicarão retroativamente direitos já constituídos.

16. LEGISLAÇÃO E CANAIS

16.1. Esta Política é regida pela legislação brasileira, especialmente pelo Código de Defesa do Consumidor e pelas normas aplicáveis ao comércio eletrônico.

16.2. Solicitações deverão ser encaminhadas pelos canais oficiais da PrussikTrails.

16.3. Questões de proteção de dados poderão ser encaminhadas para dpo@prussiktrails.com.br.
